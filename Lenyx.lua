...
function Linux:Notify(config)
    ...
    local Notification = Linux.Instance("Frame", {
        ...
        BorderColor3 = Color3.fromRGB(21, 21, 22),
        BorderSizePixel = 0,
    ...
    local ProgressBar = Linux.Instance("Frame", {
        Parent = Notification,
        BackgroundColor3 = Color3.fromRGB(21, 21, 22),
...
function Linux.Create(config)
    ...
    function LinuxLib.Tab(config)
        ...
        function TabElements.Button(config)
            ...
            local originalColor = Color3.fromRGB(21, 21, 22)
            local hoverColor = Color3.fromRGB(18, 18, 20)
            local clickColor = Color3.fromRGB(21, 21, 22)
            ...
            local function UpdateToggle(thisToggle)
                ...
                if thisTrack and thisKnob then
                    ...
                    if currentState then
                        ...
                        TweenService:Create(thisTrack, tween, {BackgroundColor3 = Color3.fromRGB(21, 21, 22)}):Play()
